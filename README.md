...
Владею опытом работы в анализе данных, машинном обучении. Страсть к данным и технологиям вдохновляет меня находить решения бизнес-задач и превращать сырые данные в ценные инсайты.
